...
- Class Component / Container Component/ Statefull Component / Smart Component (we don't use anymore according to react docs we must use functional components only)
